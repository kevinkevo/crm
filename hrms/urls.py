...
from . import views
from .views import recruitment_creation
app_name = 'hrms'
urlpatterns = [
...
# Employee Routes
    path('dashboard/employee/', views.Employee_All.as_view(), name='employee-all'),
...
#Recruitment
    ...
    path('recruitment/', recruitment_creation, name='recruitment'),
